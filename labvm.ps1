...
# install packages
choco install -y git azure-cli az.powershell vscode dotnet-6.0-sdk-1xx microsoftazurestorageexplorer googlechrome setdefaultbrowser azure-data-studio microsoft-windows-terminal GoogleJapaneseInput powershell-core sakuraeditor quicklook sharex wox
